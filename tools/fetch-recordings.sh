...
#
# Each is kept in stereo at 44.1 kHz and wrapped into a seamless loop with an
...
ffmpeg -hide_banner -loglevel error -y -ss 15 -t 25 -i "$TMP/street.mp3" -ac 2 -ar 44100 "$TMP/street_trim.wav"
...
ffmpeg -hide_banner -loglevel error -y -ss 20 -t 30 -i "$TMP/sea.mp3" -ac 2 -ar 44100 "$TMP/sea_trim.wav"
...
ffmpeg -hide_banner -loglevel error -y -ss 30 -t 25 -i "$TMP/stream.mp3" -ac 2 -ar 44100 "$TMP/stream_trim.wav"
