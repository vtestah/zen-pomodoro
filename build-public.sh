...
cp "$SRC/applet.js" "$SRC/timer.js" "$SRC/sound.js" "$SRC/menu.js" "$SRC/dialogs.js" "$SRC/constants.js" "$SRC/visual.js" "$SRC/features.js" "$SRC/stylesheet.css" "$SRC/settings-schema.json" "$FILES/"
...
for __jsf in "$FILES/applet.js" "$FILES/menu.js" "$FILES/dialogs.js" "$FILES/constants.js" "$FILES/visual.js" "$FILES/features.js"; do
python3 - "$__jsf" <<'PY'
import sys, re
f=sys.argv[1]
